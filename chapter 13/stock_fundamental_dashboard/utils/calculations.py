...
def build_summary_table(
    ...
    *,
    ...
    # Make sure annual is sorted by Year
    ...
    if "Year" in annual_df.columns:
        years = pd.to_numeric(annual_df["Year"], errors="coerce").dropna().astype(int).tolist()
    ...
    for idx, (i, r) in enumerate(annual_df.iterrows()):
        ...
        for cat, metric in ordered_metrics:
            ...
            records.append({"Category": cat, "Metric": metric, "Year": int(r.get("Year")), "Value": val})
