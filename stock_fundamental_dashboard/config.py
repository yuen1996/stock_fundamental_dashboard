    ...
    "Plantation": {
        ...
        "Other": [
            ...
            _f("Average Oil Extraction Rate (CPO) (%)", "OER", unit="%",
               help="Optional. If blank, engine computes: CPO Output ÷ FFB Input × 100."),
            _f("FFB Harvested (t)", "FFB Harvested", unit="t"),
            _f("Planted Hectares (ha)", "Planted Hectares", unit="ha"),
            _f("Yield per Hectare (FFB t/ha)", "FFB Yield", unit="t/ha",
               help="Optional. If blank, engine computes: FFB Harvested ÷ Planted Hectares."),
            _f("Average Oil Extraction Rate (CPO) (%)", "OER", unit="%"),
...
INDUSTRY_SUMMARY_RATIOS_CATEGORIES = {
    ...
    "Plantation": {
        ...
        "Operations / Industry KPIs": {
            ...
            "OER (CPO/FFB Input, %)": ["Average Oil Extraction Rate (CPO) (%)", "OER (CPO/FFB Input, %)", "OER", "OER (%)"],
            "Yield per Hectare (FFB t/ha)": ["FFB Yield (mt/ha)", "FFB Yield", "Yield per Hectare (FFB t/ha)", "Yield per Hectare"],
