    ...
    "Plantation": {
        ...
        "Operations / Industry KPIs": {
            ...
            "CPO ASP (RM/t)": [
                ...
                "Average CPO Selling Price (RM/tonne)",
                "CPO Selling Price (RM/t)",
            ],
            "OER (CPO/FFB Input, %)": [
                "OER (CPO/FFB Input, %)", "OER (%)",
            ...
            "Yield per Hectare (FFB t/ha)": [
                "Yield per Hectare (FFB t/ha)",
                "FFB Yield (mt/ha)", "FFB Yield",
                "Yield per Hectare",
            ],
            "Cash Margin per ton (RM/t)": [
                "Cash Margin per ton (RM/t)", "Cash Margin per tonne (RM/t)",
            ],
            "EBITDA per ton (RM/t)": [
                "EBITDA per ton (RM/t)", "EBITDA per tonne (RM/t)",
            ],
        },
        "Income & Efficiency": {
            "Three Fees Ratio (%)": [
