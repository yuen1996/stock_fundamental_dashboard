...
_LAST_KEYS = {
    ...
    # Plantation – Other
    "planted hectares", "unit cash cost", "cpo asp", "ffb yield", "oer",
...
INDUSTRY_FORM_CATEGORIES = {
    ...
    "Plantation": {
        ...
        "Other": [
            ...
            _f("FFB Yield (mt/ha)", "FFB Yield", unit="t/ha"),
            _f("Average Oil Extraction Rate (CPO) (%)", "OER", unit="%"),
...
INDUSTRY_SUMMARY_RATIOS_CATEGORIES = {
    ...
    "Plantation": {
        ...
        "Operations / Industry KPIs": {
            "FFB Sales Volume (t)": ["FFB Sales Volume (t)", "FFB Sales Volume", "FFB Sales Volume (tonnes)", "Tonnes Sold (t)"],
            "Unit Cash Cost (RM/t)": ["Unit Cash Cost (RM/t)", "Unit Cash Cost"],
            "CPO ASP (RM/t)": ["CPO ASP (RM/t)", "Average CPO Selling Price (RM/t)", "CPO ASP", "Average CPO Selling Price", "ASP (RM/t)"],
            "OER (CPO/FFB Input, %)": ["OER (CPO/FFB Input, %)", "OER (%)", "Average Oil Extraction Rate (CPO) (%)", "Average Oil Extraction Rate (CPO)", "Average Oil Extraction Rate"],
