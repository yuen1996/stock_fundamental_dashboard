...
# --- Soldier Worm scan switches (global) ---
# If True, Soldier Worm will also scan any metric that has a calculator
# even if it's not listed in INDUSTRY_SUMMARY_RATIOS_CATEGORIES.
SOLDIER_WORM_INCLUDE_EXTRAS: bool = True

# Optional: put labels here to skip (applies to both extras & requirements backfill)
SOLDIER_WORM_EXCLUDE: list[str] = []
...
INDUSTRY_FORM_CATEGORIES = {
    ...
    "Banking": {
        ...
        "Balance Sheet": [
            ...
            _f("Earning Assets (RM)", "Earning Assets", unit="RM"),               # <-- added so Avg EA works
