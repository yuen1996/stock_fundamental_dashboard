...
INDUSTRY_FORM_CATEGORIES = {
    ...
    "Banking": {
        ...
        "Other": [
            ...
            _f("TP (Bank) – CFO Margin Denominator: Operating Income (RM)",
                "TP_Bank_CFO_Den", unit="RM",
                help="Optional override; if blank, engine uses 'Operating Income' from the Income Statement."),     
        ],
        "Industry KPIs": [],
    },
