...
calc_sel_names = sel_names_ui[:2]

def _clear_selection():
    # Schedule a one-time clear of the multiselect BEFORE it is re-created
    st.session_state["__clear_sel_flag"] = True
    # Also clear the cross-page selection if you want it gone too
    st.session_state[GLOBAL_KEY] = []
    # no st.rerun() here — Streamlit will rerun automatically after the callback

st.button("Clear selection", key="clear_sel", on_click=_clear_selection)
