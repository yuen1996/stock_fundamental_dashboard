...
def _clear_selection():
    st.session_state[GLOBAL_KEY] = []              # clear the shared selection
    st.session_state["__clear_sel_flag"] = True    # tell next run to clear the widget UI
    # st.rerun()  # optional; Streamlit re-runs on click anyway
