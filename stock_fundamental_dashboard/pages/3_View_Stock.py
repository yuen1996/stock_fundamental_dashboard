...
/* Container that wraps the drag chips */
...
/* ------------------------------
   SMALL, SOFT PILL STYLING
   Works for streamlit-sortables (generic draggable)
   and the fallback st-draggable-list (.sdl-item).
   ------------------------------ */

/* Generic (streamlit-sortables) */
.sort-box [draggable="true"]{
  border-radius:9999px !important;     /* pill */
  background:#eef2ff !important;       /* soft indigo */
  border:1px solid #c7d2fe !important; /* light border */
  color:#0f172a !important;
  font-size:12px !important;           /* smaller text */
  padding:2px 8px !important;          /* smaller chip */
...
/* Fallback visual tweaks (st-draggable-list) */
.sdl-item, .sdl-item * {
  ...
  padding:2px 8px !important;          /* smaller */
}
</style>
"""
