...
def _clear_selection():
    # Clear the UI widget AND the cross-page selection
    st.session_state[UI_KEY] = []        # <- clears the multiselect immediately
    st.session_state[GLOBAL_KEY] = []    # <- clears the shared selection
    st.rerun()                           # <- refresh the page to reflect it
