        ...
        with tabs[0]:
            ...
            if ratio_df.empty:
                ...
                if not annual_rows_for_eval.empty:
                    ...
                    # Choose the strict playbook to display here
                    ev = rules.evaluate(metrics, "Quality-Value")  # change to "Dividend" if you prefer
                    ...
                    with cB:
                        ...
                        # List all mandatory + scored checks for transparency
                        with st.expander("See checks", expanded=False):
