        ...
        with tabs[0]:
            ...
            if ratio_df.empty:
                ...
                def ratio_series_getter(metric_name):
                    ...
                    # --- FIX: convert index to string before reindex to avoid all-NaN ---
...
st.caption("Annual charts now use soft, pill-shaped drag chips; and ratio charts show correctly. 2×2 layout keeps left/right alignment; blanks still sink to the bottom.")
