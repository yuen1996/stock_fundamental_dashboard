...
if qratio_df.empty:
    ...
    # Ensure numeric (some inputs come as strings)
    ...
    if qratio_layout.startswith("Periods"):
        # Periods → columns (metrics as rows)  — same as Annual "Years → columns"
        ...
        # Metrics → columns (periods as rows) — same as Annual default
