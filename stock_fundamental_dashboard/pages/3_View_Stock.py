        ...
        with tabs[0]:
            ...
            if ratio_df.empty:
                ...
                if len(years) >= 2:
                    ...
                    cagr_eps = ((eps_last / eps_first) ** (1/period) - 1) * 100 if eps_first > 0 else None

                    # Estimate next 3‑year EPS
                    ...
                    mos = ((graham_val - price_latest) / graham_val * 100) if graham_val > 0 else None
                    ...
                    c2.metric("Est EPS (3‑yr)", f"{est_eps_3y:,.4f}")
                    ...
                    c4.metric("Graham Value",       f"{graham_val:,.2f}")
