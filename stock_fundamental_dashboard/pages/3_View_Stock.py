    ...
    with st.expander(stock_name, expanded=False):
        ...
        with tabs[0]:
            ...
            if ann_numeric.empty:
                ...
                if inter_ann_raw:
                    st.dataframe(disp_num, use_container_width=True, height=_auto_height(disp_num) if full_h_ann_raw else 420)
                else:
                    if ann_raw_layout.startswith("Years"):
                    ...
                    _show_styled(styled, height=9999 if full_h_ann_raw else 420)
            ...
            if ratio_df.empty:
                ...
                if ratio_layout.startswith("Years"):
                    ...
                    if inter_ann_ratio:
                        st.dataframe(disp, use_container_width=True, height=_auto_height(disp) if full_h_ann_ratio else 360)
                    else:
                        _show_styled(styled, height=9999 if full_h_ann_ratio else 360)
