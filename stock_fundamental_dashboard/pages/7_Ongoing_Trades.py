...
# NOTE: keep NaN when TTM DPS is missing (so you see missing data instead of 0% yields).
ttm_dps = pd.to_numeric(filtered["Name"].map(lambda n: get_ttm_dps(str(n))), errors="coerce")

# Projected dividends (TTM DPS × Shares)
