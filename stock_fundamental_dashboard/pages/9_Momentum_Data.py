...
def _resolve_ohlc_dir() -> str:
    """
    Prefer project path; still read/write from a home fallback if perms block.
    Env override: ST_OHLC_DIR=/path
    """
...
# 🔧 Force the OHLC path into a guaranteed-writable home folder
os.environ["SFD_OHLC_DIR"] = _alt_ohlc_dir()   # ~/.app_state/ohlc
os.environ["OHLC_DIR"]     = os.environ["SFD_OHLC_DIR"]
