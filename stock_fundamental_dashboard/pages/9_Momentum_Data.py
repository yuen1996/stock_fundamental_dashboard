...
# ---------- Styling (match other pages, dark mode) ----------
BASE_CSS = """
<style>
:root{
  --bg:#0f172a; --surface:#1e293b; --text:#f1f5f9; --muted:#94a3b8;
  --border:#334155; --shadow:0 8px 24px rgba(0, 0, 0, .3);
  --primary:#4f46e5; --info:#0ea5e9; --success:#10b981; --warning:#f59e0b; --danger:#ef4444;
}
.stApp, [data-testid="stSidebar"] {
  background: radial-gradient(1000px 500px at 10% -10%, #1f2937 0%, var(--bg) 60%), var(--bg);
}
...
.sec .t{ font-size:1.05rem; font-weight:800; margin:0; color:var(--text)!important; }
