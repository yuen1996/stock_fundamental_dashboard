...
def _render_stats(stats, label=\"Selected range\"):
    ...
    st.markdown(
        f\"**{label}:** {stats['first'].date()} → {stats['last'].date()}  \"  # noqa: E501
        f\"• rows: **{stats['rows']:,}**  • business days: **{stats['biz_days']:,}**  \"  # noqa: E501
        f\"• coverage: **{cov}**  • MA200: {ok_ma}  • 12-mo return: {ok_12}  \"  # noqa: E501
        f\"• gaps (max/avg days): {stats['max_gap_days']}/{stats['mean_gap_days']:.1f}\"  # noqa: E501
    )
