...
# Build custom hovertext for candles (works on older Plotly)
...
# Candles (no hovertemplate; use hovertext for compatibility)
...
# Volume (secondary y) – also switch to hovertext for compatibility
