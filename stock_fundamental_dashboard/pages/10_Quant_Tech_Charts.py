...
def _alias_candidates(x: str) -> list[str]:
    ...
    # generic removal (case-insensitive)
...
def _ohlc_path_for(stock_name: str) -> str | None:
    ...
    try:
        ...
        pass
    # default guess (helps show exactly what we looked for)
    return exact
...
# Momentum Data bumps a bus "ohlc" version; prefer that to invalidate cache immediately
try:
