...
with st.form("stock_settings_form", clear_on_submit=False):
    # Stock name (typed), then we re-read Industry & Bucket from existing rows for this name
    ...
    with c1:
        ...
        industry = st.text_input(
            "Industry (free text)",
            value=industry_text_prefill,
            help="Prefilled from your saved rows for this stock; you can override here."
        )
    with c2:
        bucket_prefill = (
        ...
        bucket = st.selectbox(
            ...
            help="Prefilled from your saved rows for this stock; used across the app."
        )

    # Field preview (annual) to show what's in this bucket
    try:
    ...
    # Prefill current price from saved meta (old behavior). Leave blank to clear.
