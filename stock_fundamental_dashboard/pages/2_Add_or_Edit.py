...
with st.form("stock_settings_form", clear_on_submit=False):
    ...
    if use_manual:
        ...
        if mom_px is None:
            st.text_input("Current Price", value="", placeholder="—", key="cur_price_stock_num_display", disabled=True)
...
if submit_settings:
    if not stock_name:
        ...
        # NEW: read the always-rendered manual field and the radio selection
