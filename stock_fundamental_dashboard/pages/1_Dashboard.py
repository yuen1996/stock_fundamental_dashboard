...
if df_view.empty:
    ...
    # --- center the Latest‑year Summary table ---
    table_html = summary.to_html(escape=False, index=False)
    table_html = """
    <style>
...
if quarterly.empty:
    ...
    # --- center the Latest‑quarter Summary table ---
    table_html = qsummary.to_html(escape=False, index=False)
    table_html = """
    <style>
      table { margin-left: auto; margin-right: auto; }
      table th, table td { text-align: center !important; }
