...
# ---- Safety locks (use PLANNED size, not risk-based) ----
min_rr = st.slider(
...
# We'll use rr_ok_planned & ev_ok later to disable Save/Update buttons


# ---- Planned sizing (define before Safety locks) ----
...
disabled = not (planned_shares > 0 and np.isfinite(risk_per_share) and risk_per_share > 0 and rr_ok_planned and ev_ok)
