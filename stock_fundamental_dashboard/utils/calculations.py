    ...
    *,
    ...
    if include_ttm and not quarterly_df.empty:
        ...
        if prev_row:
            ...
            _copy_if_missing("CET1 Ratio (%)",
                             "CET1 Ratio (%)", "CET1 Ratio", "CET1 (%)", "CET1")
            _copy_if_missing("Tier 1 Capital Ratio (%)",
                             "Tier 1 Capital Ratio (%)", "Tier 1 Ratio (%)", "Tier 1 Ratio", "Tier 1 (%)")
            _copy_if_missing("Total Capital Ratio (%)",
