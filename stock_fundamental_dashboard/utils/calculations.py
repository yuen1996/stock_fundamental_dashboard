...
RAW_ALIASES.update({
    ...
    "cpo_asp": ["CPO ASP (RM/t)", "Average CPO Selling Price (RM/t)", "Average CPO Selling Price"],
    ...
    "tonnes_sold": ["Tonnes Sold (t)", "FFB Sales Volume (tonnes)", "FFB Sales Volume"],
...
def _plantation_calcs() -> Dict[str, Calculator]:
    ...
    def _ebitda_per_ton(r, p, c):
        # Prefer manual; else (optional) proxy = group EBITDA / tonnes sold.
