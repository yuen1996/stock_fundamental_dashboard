...
def build_soldier_worm_fixlist(
    ...
    *,
    ...
    """Actionable fix list: which raw inputs to fill first (based on soldier_worm missing report)."""
    from utils import soldier_worm as _sw
    return _sw.build_soldier_worm_fixlist(warn_df, bucket=bucket, top_n=top_n)
...
def decorate_soldier_worm_missing_table(
    ...
    *,
    ...
    """Add UI columns to the missing-inputs table: Where to Fill + Form Keys."""
    from utils import soldier_worm as _sw
    return _sw.decorate_soldier_worm_missing_table(warn_df, bucket=bucket)
