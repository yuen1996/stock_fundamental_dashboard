...
DATA_DIR  = os.path.abspath(os.path.expanduser(os.environ.get("SFD_DATA_DIR", os.path.join(_PKG_ROOT, "data"))))
DATA_FILE = os.path.abspath(os.path.expanduser(os.environ.get("SFD_DATA_FILE", os.path.join(DATA_DIR, "fundamentals.csv"))))
