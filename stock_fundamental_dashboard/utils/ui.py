...
/* Keep Streamlit sidebar reopen arrow visible.
   When the sidebar is collapsed, Streamlit renders the reopen control in the top toolbar.
   If the toolbar is hidden, you can’t reopen the sidebar without refresh. */
[data-testid="stToolbar"]{ visibility: visible !important; }

/* Make the collapsed sidebar control easy to click + looks premium */
