...
PAGES_TRADING = [
    ...
    # If you really have this page but with a different filename,
    # change the path below to the actual filename (e.g. pages/11_Long_Trade_Dividends.py)
    ("pages/Long_Trade_Dividends.py",   "💸 Long Trade Dividends"),
]
PAGES_QUANT = [
    ("pages/9_Momentum_Data.py",        "⚡ Momentum Data"),
    ("pages/10_Quant_Tech_Charts.py",   "🧪 Quant Tech Charts"),
    # Likewise, update the path if your file is named differently.
    ("pages/AI_Analyst.py",             "🤖 AI Analyst"),
]
